...
reason: "Requires active review session via /review MCP flow — cannot test without an attached Claude Code session invoking start_review + set_pr_summary."
...
result: blocked
blocked_by: prior-phase
reason: "Requires active review session with diff data — cannot test without an attached Claude Code session."
...
result: blocked
blocked_by: prior-phase
reason: "Requires active review session with diff data and findings."
...
result: blocked
blocked_by: prior-phase
reason: "Requires active review session."
